...
#python cluster_gpu.py --ps_hosts=127.0.0.1:2222 --worker_hosts=127.0.0.1:2224,127.0.0.1:2225 --job_name=ps --task_index=0
#python cluster_gpu.py --ps_hosts=127.0.0.1:2222 --worker_hosts=127.0.0.1:2224,127.0.0.1:2225 --job_name=worker --task_index=0 --gpu_num=1
#python cluster_gpu.py --ps_hosts=127.0.0.1:2222 --worker_hosts=127.0.0.1:2224,127.0.0.1:2225 --job_name=worker --task_index=1 --gpu_num=1
    ...
    server.join()
      ...
      for i in range(FLAGS.gpu_num):
          with tf.device(tf.train.replica_device_setter(
              worker_device="/job:worker/task:%d/gpu:%d" %(FLAGS.task_index,i), 
              cluster=cluster)):
